...
var budgetsSlice = (0, _toolkit.createSlice)({
  ...
  reducers: {
    editBudget: function editBudget(state, action) {
      ...
      var amount = action.payload.amount; // Update the state by "finding" the budget object
...
var transactionsSlice = (0, _toolkit.createSlice)({
  ...
  reducers: {
    ...
    deleteTransaction: function deleteTransaction(state, action) {
      ...
      var category = action.payload.category; // It should delete the old transaction (action.payload) from the correct category’s transaction list in the transactions state object.
